 ...
 * @since 2.5
 */
class JedisInvoker<C extends JedisCommands> {

    private final Synchronizer<C> synchronizer;

    JedisInvoker(Synchronizer<C> synchronizer) {
     ...
     */
    @Nullable
    <R> R just(ConnectionFunction0<R, C> function) {
     ...
     */
    @Nullable
    <R> R just(ConnectionFunction0<R, C> function, PipelineFunction0<R> pipelineFunction) {
     ...
     */
    @Nullable
    <R, T1> R just(ConnectionFunction1<T1, R, C> function, PipelineFunction1<T1, R> pipelineFunction, T1 t1) {
     ...
     */
    @Nullable
    <R, T1, T2> R just(ConnectionFunction2<T1, T2, R, C> function, PipelineFunction2<T1, T2, R> pipelineFunction, T1 t1,
                       T2 t2) {
     ...
     */
    @Nullable
    <R, T1, T2, T3> R just(ConnectionFunction3<T1, T2, T3, R, C> function, PipelineFunction3<T1, T2, T3, R> pipelineFunction,
                           T1 t1, T2 t2, T3 t3) {
     ...
     */
    @Nullable
    <R, T1, T2, T3, T4> R just(ConnectionFunction4<T1, T2, T3, T4, R, C> function,
     ...
     */
    @Nullable
    <R, T1, T2, T3, T4, T5> R just(ConnectionFunction5<T1, T2, T3, T4, T5, R, C> function,
     ...
     */
    @Nullable
    <R, T1, T2, T3, T4, T5, T6> R just(ConnectionFunction6<T1, T2, T3, T4, T5, T6, R, C> function,
     ...
     * @param function must not be {@literal null}.
     */
    <R> SingleInvocationSpec<R> from(ConnectionFunction0<R, C> function) {
     ...
     * @param pipelineFunction must not be {@literal null}.
     */
    <R> SingleInvocationSpec<R> from(ConnectionFunction0<R, C> function, PipelineFunction0<R> pipelineFunction) {
     ...
     * @param t1               first argument.
     */
    <R, T1> SingleInvocationSpec<R> from(ConnectionFunction1<T1, R, C> function, PipelineFunction1<T1, R> pipelineFunction,
                                         T1 t1) {
     ...
     * @param t2               second argument.
     */
    <R, T1, T2> SingleInvocationSpec<R> from(ConnectionFunction2<T1, T2, R, C> function,
     ...
     * @param t3               third argument.
     */
    <R, T1, T2, T3> SingleInvocationSpec<R> from(ConnectionFunction3<T1, T2, T3, R, C> function,
     ...
     * @param t4               fourth argument.
     */
    <R, T1, T2, T3, T4> SingleInvocationSpec<R> from(ConnectionFunction4<T1, T2, T3, T4, R, C> function,
                                                     PipelineFunction4<T1, T2, T3, T4, R> pipelineFunction, T1 t1, T2 t2, T3 t3, T4 t4) {
     ...
     * @param t5               fifth argument.
     */
    <R, T1, T2, T3, T4, T5> SingleInvocationSpec<R> from(ConnectionFunction5<T1, T2, T3, T4, T5, R, C> function,
                                                         PipelineFunction5<T1, T2, T3, T4, T5, R> pipelineFunction, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) {
     ...
     * @param t6               sixth argument.
     */
    <R, T1, T2, T3, T4, T5, T6> SingleInvocationSpec<R> from(ConnectionFunction6<T1, T2, T3, T4, T5, T6, R, C> function,
                                                             PipelineFunction6<T1, T2, T3, T4, T5, T6, R> pipelineFunction, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
     ...
     * @param function must not be {@literal null}.
     */
    <R extends Collection<E>, E> ManyInvocationSpec<E> fromMany(ConnectionFunction0<R, C> function) {
    ...
    <R extends Collection<E>, E> ManyInvocationSpec<E> fromMany(ConnectionFunction0<R, C> function,
        ...
        return new DefaultManyInvocationSpec<>((Function<C, R>) function::apply, pipelineFunction::apply, synchronizer);
    }
     ...
     * @param t1               first argument.
     */
    <R extends Collection<E>, E, T1> ManyInvocationSpec<E> fromMany(ConnectionFunction1<T1, R, C> function,
     ...
     * @param t2               second argument.
     */
    <R extends Collection<E>, E, T1, T2> ManyInvocationSpec<E> fromMany(ConnectionFunction2<T1, T2, R, C> function,
                                                                        PipelineFunction2<T1, T2, R> pipelineFunction, T1 t1, T2 t2) {
     ...
     * @param t3               third argument.
     */
    <R extends Collection<E>, E, T1, T2, T3> ManyInvocationSpec<E> fromMany(ConnectionFunction3<T1, T2, T3, R, C> function,
                                                                            PipelineFunction3<T1, T2, T3, R> pipelineFunction, T1 t1, T2 t2, T3 t3) {
    ...
    <R extends Collection<E>, E, T1, T2, T3, T4> ManyInvocationSpec<E> fromMany(
            ConnectionFunction4<T1, T2, T3, T4, R, C> function, PipelineFunction4<T1, T2, T3, T4, R> pipelineFunction, T1 t1,
            T2 t2, T3 t3, T4 t4) {
    ...
    <R extends Collection<E>, E, T1, T2, T3, T4, T5> ManyInvocationSpec<E> fromMany(
            ConnectionFunction5<T1, T2, T3, T4, T5, R, C> function, PipelineFunction5<T1, T2, T3, T4, T5, R> pipelineFunction,
    ...
    <R extends Collection<E>, E, T1, T2, T3, T4, T5, T6> ManyInvocationSpec<E> fromMany(
            ConnectionFunction6<T1, T2, T3, T4, T5, T6, R, C> function,
            PipelineFunction6<T1, T2, T3, T4, T5, T6, R> pipelineFunction, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
     ...
     */
    @FunctionalInterface
    interface ConnectionFunction0<R, C extends JedisCommands> {
     ...
     */
    @FunctionalInterface
    interface ConnectionFunction1<T1, R, C extends JedisCommands> {
     ...
     */
    @FunctionalInterface
    interface ConnectionFunction2<T1, T2, R, C extends JedisCommands> {
         ...
         * @param t2         second argument.
         */
        R apply(C connection, T1 t1, T2 t2);
    }
     ...
     */
    @FunctionalInterface
    interface ConnectionFunction3<T1, T2, T3, R, C extends JedisCommands> {
         ...
         * @param t3         third argument.
         */
        R apply(C connection, T1 t1, T2 t2, T3 t3);
    }
     ...
     */
    @FunctionalInterface
    interface ConnectionFunction4<T1, T2, T3, T4, R, C extends JedisCommands> {
         ...
         * @param t4         fourth argument.
         */
        R apply(C connection, T1 t1, T2 t2, T3 t3, T4 t4);
    }
     ...
     */
    @FunctionalInterface
    interface ConnectionFunction5<T1, T2, T3, T4, T5, R, C extends JedisCommands> {
         ...
         * @param t5         fifth argument.
         */
        R apply(C connection, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5);
    }
     ...
     */
    @FunctionalInterface
    interface ConnectionFunction6<T1, T2, T3, T4, T5, T6, R, C extends JedisCommands> {
         ...
         * @param t6         sixth argument.
         */
        R apply(C connection, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6);
    }
    ...
    static class DefaultSingleInvocationSpec<S, C extends JedisCommands> implements SingleInvocationSpec<S> {

        private final Function<C, S> parentFunction;
        private final Function<ResponseCommands, Response<S>> parentPipelineFunction;
        private final Synchronizer<C> synchronizer;

        DefaultSingleInvocationSpec(Function<C, S> parentFunction,
    ...
    static class DefaultManyInvocationSpec<S, C extends JedisCommands> implements ManyInvocationSpec<S> {

        private final Function<C, Collection<S>> parentFunction;
        private final Function<ResponseCommands, Response<Collection<S>>> parentPipelineFunction;
        private final Synchronizer<C> synchronizer;

        @SuppressWarnings({"rawtypes", "unchecked"})
        DefaultManyInvocationSpec(Function<C, ? extends Collection<S>> parentFunction,
     ...
     */
    @FunctionalInterface
    interface Synchronizer<C extends JedisCommands> {

        @Nullable
        @SuppressWarnings({"unchecked", "rawtypes"})
        default <I, T> T invoke(Function<C, I> callFunction, Function<ResponseCommands, Response<I>> pipelineFunction) {
        ...
        @Nullable
        Object doInvoke(Function<C, Object> callFunction, Function<ResponseCommands, Response<Object>> pipelineFunction,
